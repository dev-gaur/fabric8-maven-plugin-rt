...
public class BaseBoosterIT {
    ...
    protected final String fmpPomUrl = "https://raw.githubusercontent.com/fabric8io/fabric8-maven-plugin/master/pom.xml";
    ...
    private void modifyPomFileToProjectVersion(Repository aRepository, String relativePomPath) throws IOException, XmlPullParserException {
        ...
        URL fmpRepoURL = new URL(fmpPomUrl);
        File pomFile = File.createTempFile("pom", "xml");
        FileUtils.copyURLToFile(fmpRepoURL, pomFile);
        String fmpCurrentVersion = readPomModelFromFile(pomFile).getVersion();
